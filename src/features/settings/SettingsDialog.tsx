        ...
        <div className="settings-content">
          ...
          {section === "display" ? (
            <section aria-labelledby="display-settings-title">
              ...
              <hr />
              <fieldset className="settings-option-panel">
                <legend>미니맵</legend>
                <p className="settings-help">
                  미니맵에는 지도와 플레이어 위치만 표시됩니다. 확대는 Alt + +, 축소는 Alt + - 키를 사용하세요.
                </p>
                <div className="settings-grid">
                  <label>
                    <span>미니맵 화면 방식</span>
                    <select
                      ...
                      value={settings.map.miniMapViewMode}
                    >
                  ...
                  <label>
                    <span>미니맵 확대율 {Math.round(settings.map.miniMapZoom * 100)}%</span>
                    <input
                      aria-label="미니맵 확대율"
                      max="400"
                      min="1"
                      ...
                      step="1"
                      type="range"
                      value={Math.round(settings.map.miniMapZoom * 100)}
                    />
                  </label>
                  <label>
                    <span>미니맵 투명도 {Math.round(settings.map.miniMapOpacity * 100)}%</span>
                    <input
                      aria-label="미니맵 투명도"
                      max="100"
                      min="10"
                      ...
                      type="range"
                      value={Math.round(settings.map.miniMapOpacity * 100)}
                    />
                  </label>
                  <label>
                    <span>
                      미니맵 플레이어 크기 {Math.round(settings.map.miniMapPlayerMarkerScale * 100)}%
                    </span>
                    <input
                      ...
                      type="range"
                      value={Math.round(settings.map.miniMapPlayerMarkerScale * 100)}
                    />
                  </label>
                </div>
                <div className="settings-option-actions">
                  <button
                    disabled={
                      settings.map.miniMapOffsetX === 0 &&
                      settings.map.miniMapOffsetY === 0
                    }
