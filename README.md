...
- 플레이어 추적/고정 보기·팬·줌을 지원하는 300×300 미니맵
...
미니맵은 Edge/Chrome의 Document Picture-in-Picture를 지원하면 별도 항상 위 창에 가깝게 열리고,
미지원 환경에서는 페이지 안 고정 패널로 열립니다. 브라우저 제약상 게임 창으로 마우스 클릭을
통과시키는 기능과 전역 단축키는 제공하지 않습니다. 퀘스트 적용·위치 계산·프로필 분리 결과는
데스크톱 앱과 같습니다.
