...
If Not fileSystem.FileExists(powerShellPath) Then
  ...
  WScript.Quit 1
End If
powerShellCommand = "& ([IO.Path]::Combine($env:TARKOV_HELPER_PACKAGE_ROOT, 'start-menu.ps1')) -Action Register"
...
If exitCode = 0 Then
  MsgBox "Tarkov Helper was added to the Windows Start menu.", 64, "Tarkov Helper"
Else
  MsgBox "Tarkov Helper could not be added to the Windows Start menu.", 16, "Tarkov Helper"
End If
